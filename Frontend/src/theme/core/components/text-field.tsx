  ...
  input: [
    ...
    },
    {
      props: (props: any) => {
        ...
        return (size || ownerState?.inputSize) === 'small';
      },
      style: { ...INPUT_PADDING.base.small },
    },
  ],
...
export const filledInputVariants = {
  ...
  input: [
    ...
    {
      props: (props: any) => !!((props as any).hiddenLabel),
      style: { ...INPUT_PADDING.filled.mediumHidden },
    },
    {
      props: (props: any) => {
        const size = (props as any).size;
        const hiddenLabel = (props as any).hiddenLabel;
        const ownerState = (props as any).ownerState;
        return !!hiddenLabel && (size || ownerState?.inputSize) === 'small';
      },
      style: { ...INPUT_PADDING.filled.smallHidden },
    },
  ],
