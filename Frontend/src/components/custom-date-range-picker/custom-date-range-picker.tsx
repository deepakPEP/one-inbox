    ...
    >
      ...
      >
        {isCalendarView ? (
          <>
            <DateCalendar 
              {...({ value: startDate, onChange: (newValue: any) => onChangeStartDate(newValue) } as any)}
            />
            <DateCalendar 
              {...({ value: endDate, onChange: (newValue: any) => onChangeEndDate(newValue) } as any)}
            />
          </>
        ) : (
          <>
            <DatePicker 
              ...
              slotProps={{ textField: { label: 'Start date' } }} 
            />
            <DatePicker 
              {...({ value: endDate } as any)}
              onChange={onChangeEndDate} 
              slotProps={{ textField: { label: 'End date' } }} 
            />
          </>
        )}
